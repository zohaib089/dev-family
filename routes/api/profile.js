...
//@routes to Get api/profile to get current user profile
//@desxription  Get CURrent user profile
//@access      private
//protected Routed
router.get(
  '/',
...
//@desxription  GEt Profile by Handle
//@access     public
//protected Routed
...
//@desxription  GEt Profile by User Id
//@access     public
//protected Routed
...
//@routes to Post api/profile
//@desxription  to Create or Edit user profile
//@access      private
//protected Routed
router.post(
  '/',
  ...
  (req, res) => {
    ...
    //Get Fields
    const profileFields = {};
    profileFields.user = req.user.id; //(that will include user detail)
